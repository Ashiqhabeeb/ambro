			...
			<div class="container-fluid bg-style media1">
				...
				<div class="row">
					...
					<div class="col-md-12 log-style">
						<form action="logcheck2.php" name="login" method="post" class="m-auto py-3 jumbotron text-light p-3 form-style rounded">

							
							<h3 div class="text-center text-dark">Sign In</h3>
								<input type="text" class="form-control inputcomponent mt-md-3 space" name='username' required="required" placeholder="student name">
